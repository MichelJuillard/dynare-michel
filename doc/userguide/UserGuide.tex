...
Copyright © 2007-2010 Tommaso Mancini Griffoli
...
\begin{itemize}
\item Stéphane Adjemian (stephane.adjemian``AT''ens.fr)
...
\item Sébastien Villemot (sebastien.villemot``AT''ens.fr)
\end{itemize}
